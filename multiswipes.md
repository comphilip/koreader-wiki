Multiswipes (or multiswipe gestures) are commands you give by swiping finger on screen in more than one direction. You can access configuration menu in `Settings → Taps and gestures`.
